...
@Log4j
@IocBean
public class ArtCatalogService extends BaseService {


	public PageResult<ArtCatalog> queryPage(ArtCatalog obj) {
		return super.queryPage(ArtCatalog.class, obj, getCri(obj));
	}

	public List<ArtCatalog> query(ArtCatalog obj) {
		return super.query(ArtCatalog.class, getCri(obj));
	}

   	public ArtCatalog get(String id) {
		return super.fetch(ArtCatalog.class, id);
	}
	...
	public int delete(String ids) {
		if(StringTool.isNotNull(ids)) {
			...
			return super.delete(ArtCatalog.class, cri);
		}
		return 0;
	}
	...
	private SimpleCriteria getCri(ArtCatalog obj) {
		SimpleCriteria cri = Cnd.cri();

		if(StringTool.isNotNull(obj.getType())) {
			cri.where().andEquals("TYPE", obj.getType());
		}
		if(StringTool.isNotNull(obj.getProcessor())) {
			cri.where().andEquals("PROCESSOR", obj.getProcessor());
		}
